...
Route::get('/product/addcart/{id}',[productController::class,'Addcart'])->name('products.addcart');

Route::get('/product/cartlist',[productController::class,'cartlist'])->name('product/cartlist');
