...
<head>
    ...
    <title>user's Product Review List</title>
    <style>
        body {
            max-width: 100%;
            overflow-x: hidden;
...
<div class="row">
    <div class="col-3" style="background-image: linear-gradient(45deg,  #3D0000,#0b006e)">
        <div>
            ...
            @elseif(session('role') == 'use')
            @include('pages.use.customerSideBar')
            @endif
        </div>
    </div>
    <div class="col-9">
        <div>
            <div class="d-flex justify-content-center align-items-center" style="min-height: 88vh; width: 100%">
                <div>
                    ...
                    <a  href={{ "/userOrders/" .session('id') }} class="btn btn-primary btn-sm mt-3">Order List</a>
