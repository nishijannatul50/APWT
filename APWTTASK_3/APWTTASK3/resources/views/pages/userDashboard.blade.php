...
<body>
    ...
    <div class="row">
        ...
        <div class="col-3" style="min-height: 99vh; background-image: linear-gradient(45deg,  #3D0000,#0b006e)">
        ...
        <div class="col-9">
            ...
            <div class="text-center">
                ...
                @endif
                @if(session('user-info-update'))
                <div class="mt-3 fw-bold d-flex justify-content-center align-items-center"
                    style="height: 30px; font-size:13px; color:red; padding:10px; width:100%; background: black; border-radius: 20px">
                    {{ session('user-info-update') }}
                </div>
                @endif
            </div>
            <div class="row" style="height: 90vh;">
                <div class="col-md-6">
                    <div class="d-flex align-items-center justify-content-center" style="height: 90vh;">
                        <div class="p-5"
                            style="border-radius: 10px; background-image: linear-gradient(45deg,  #3D0000,#0b006e); height: 400px;width:430px ;box-shadow: 3px 3px 10px gray;">
                            <h4 class="mb-5 fw-bold text-danger text-uppercase">Profile Picture</h4>
                            <img src="{{ asset('uploads/userProfile/'.$user->image) }}"
                                alt="{{ $user->name }}" width="130px" height="160px">
                            @if($user->image == '')
                            <form action="{{route('userDashboard')}}" method="GET" enctype="multipart/form-data">
                                {{csrf_field()}}
                ...
                <div class="col-md-6">
                    <div class="d-flex align-items-center justify-content-center" style="height: 90vh;">
                        <div class="p-5"
                            style="border-radius: 10px; background-image: linear-gradient(45deg,  #3D0000,#0b006e); height: 400px; width:430px; box-shadow: 3px 3px 10px gray;">
                            <h4 class="mb-5 fw-bold text-danger text-uppercase">User Information</h4>
                            ...
                            <div>
                                <a href={{ "editUserProfile/" .$user->id}} class="btn btn-warning btn-sm">Edit
                                    Profile</a>
                                ...
                                <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <a class="btn btn-danger btn-sm" href={{ "deleteUserAccount/"
                                                    .$user->id }}>Delete Account</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
