        ...
        <div>
            <div class="d-flex justify-content-center align-items-center" style="min-height: 88vh; width: 100%">
                <div>
                    ...
                    @endif
                    <h4 class="my-4 fw-bold text-uppercase"> <span class="text-danger">{{ $User->name }}'s</span> All Orders</h4>
                    ...
                    <a href={{route('userDashboard')}} class="btn btn-success btn-sm mt-3 px-3">Home</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div>
            <div class="d-flex justify-content-center align-items-center" style="min-height: 88vh; width: 100%">
                <div>
                    ...
                    <a  class="btn btn-primary btn-sm mt-3" href={{ route('product.list') }}>SEE All Products</a>
                    <a  class="btn btn-success btn-sm mt-3" href={{ route('userDashboard') }}>Home</a>
